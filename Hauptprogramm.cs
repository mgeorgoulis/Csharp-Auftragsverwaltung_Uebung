...
//AuftragTests.TestsAusfuehren();

//AuftragTests.ErhoeheGehaltTesten(); 

public static NeueGewichtsEingabe(AuftragTests auftrag)
{
    string auftrag1 =  auftrag;
...
{ 
    ...
    try
    { 
        neuesGewicht = double.Parse(Eingabe);
        
        auftrag1.GewichtAendern(neuesGewicht);
